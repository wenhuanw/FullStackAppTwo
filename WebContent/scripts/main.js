...
function initGeoLocation() {
  if (navigator.geolocation) {
	  // get users' location, when success, call onPositionUpdated
	  // if fails, call onLoadPositionFailed
	  // cache the users' location for 60000ms
 ...
 * be used in sessionValid and sessionInvalid
 */
...
/*
 * helper function to display the element
 * be used in sessionValid and sessionInvalid
 */
...
function ajax(method, url, data, callback, errorHandler) {
  ...
  // true means asychronous operation
