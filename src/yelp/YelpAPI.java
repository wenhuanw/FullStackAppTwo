...
// all the methods here might be called by methods in db package
public class YelpAPI {
	private static final String API_HOST = "api.yelp.com";
	private static final String DEFAULT_TERM = "dinner";
	private static final int SEARCH_LIMIT = 20;
	private static final String SEARCH_PATH = "/v2/search";
	private static final String CONSUMER_KEY = "W0hqcKG0I5Nw25lI2u4ILg";
	private static final String CONSUMER_SECRET = "8qSmt7WCaen_RJvl0Ba4B9YoJ1Y";
	private static final String TOKEN = "pQ_kuptUShno336kvU6ecV-QKlavXPsU";
	private static final String TOKEN_SECRET = "qOfGp_wCzieb2sqJ8ROI5pmCIi8";
	 ...
	 * first result to query the Business API. Just for test
	 */
