...
public class DBYelpImport {
	...
	public static void main(String[] args) {
		try {
			 ...
			 * stmt.executeUpdate(sql);
			 * 
			 * sql = "DROP TABLE IF EXISTS users"; stmt.executeUpdate(sql);
			 */
			
			/*
			// step2 create tables
			Statement stmt = conn.createStatement();
			String sql = "CREATE TABLE restaurants " + "(business_id VARCHAR(255) NOT NULL, " + " name VARCHAR(255), "
			...
			*/
			...
			// Create a fake user
			Statement stmt = conn.createStatement();
			String sql = "INSERT INTO users " + "VALUES (\"1111\", \"3229c1097c00d497a0fd282d586be050\", \"John\", \"Smith\")";
